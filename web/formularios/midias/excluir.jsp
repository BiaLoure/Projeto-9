            ...
            <div class="col-md-8 col-lg-6">
                <form method="post" action="${cp}/processaMidias" class="mb-4">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" value="${requestScope.midia.titulo}" disabled>
                    </div>
                    
                    <div class="form-group">
                        <label for="descricao">Ano Lançamento</label>
                        <input class="form-control" value="${requestScope.midia.anoLancamento}" disabled>
                    </div>
                    
                    <div class="form-group">
                        <label for="descricao">Codigo de Barras</label>
                        <input class="form-control" value="${requestScope.midia.codigoBarras}" disabled>
                    </div>
                    
                    <div class="form-group">
                        <label for="descricao">Duração</label>
                        <input class="form-control" value="${requestScope.midia.duracaoMinutos}" disabled>
                    </div>
                    
                    <div class="form-group">
                        <label for="descricao">Ator Principal</label>
                        <input class="form-control" value="${requestScope.midia.atorPrincipal.nome} ${requestScope.midia.atorPrincipal.sobrenome}" disabled>
                        
                    </div>
                    
                    <div class="form-group">
                        <label for="descricao">Ator Secundario</label>
                        <input class="form-control" value="${requestScope.midia.atorCoadjuvante.nome} ${requestScope.midia.atorCoadjuvante.sobrenome}" disabled>
                        
                    </div>
                    
                    <div class="form-group">
                        <label for="descricao">Genero</label>
                        <input class="form-control" value="${requestScope.midia.genero.descricao}" disabled>
                    
                    </div>
                    
                    <div class="form-group">
                        <label for="descricao">Classificação Etária</label>
                        <input class="form-control" value="${requestScope.midia.classificacaoEtaria.descricao}" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" value="${requestScope.midia.tipo.descricao}" disabled>
                        
                    </div>
                    
                    <div class="form-group">
                        <label for="descricao">Classificação Interna</label>
                        <input class="form-control" value="${requestScope.midia.classificacaoInterna.descricao}" disabled>
