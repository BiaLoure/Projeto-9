                ...
                <form method="post" action="${cp}/processaAtor" class="mb-4">
                    ...
                    <div class="form-group">
                        <label for="nome">Nome</label>
                            <input class="form-control" value="${requestScope.ator.nome}" disabled>
                    </div>
                    
                     <div class="form-group">
                        <label for="sobrenome">Sobrenome</label>
                            <input class="form-control" value="${requestScope.ator.sobrenome}" disabled>
                    </div>
                    
                    <div class="form-group">
                        <label for="dataEstreia">Data Estreia</label>
                            <input class="form-control" value="${requestScope.ator.dataEstreia}" disabled>
                    </div>
