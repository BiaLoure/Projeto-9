     ...
     <div class="container border my-4 shadow p-4 bg-light">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <form method="post" action="${cp}/processaTipos" class="mb-4">
                    ...
                    <div class="form-group">
                        <label for="descricao">Descricao</label>
                            <input class="form-control" value="${requestScope.tipo.descricao}" disabled>
                    </div>
                    ...
                    <div class="d-flex justify-content-between mt-5">
                        <a href="${cp}/formularios/tipos/listagem.jsp" class="btn btn-secondary">Voltar</a>
