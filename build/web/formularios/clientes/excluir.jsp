                ...
                <form method="post" action="${cp}/processaClientes" class="mb-4">
                    ...
                    <div class="form-group">
                        <label for="nome">Nome</label>
                            <input class='form-control' value='${requestScope.cliente.nome}' required disabled>
                    </div>
                    
                    <div class="form-group">
                        <label for="nome">Sobrenome</label>
                           <input class='form-control' value='${requestScope.cliente.sobrenome}' required disabled>
                    </div>
                    
                    <div class="form-group">
                        <label for="dataNascimento">Data Nascimento</label>
                           <input class='form-control' value='${requestScope.cliente.dataNascimento}' required disabled>
                    </div>
                    
                    <div class="form-group">
                        <label for="cpf">CPF</label>
                            <input class='form-control' value='${requestScope.cliente.cpf}' required disabled>
                    </div>
                    
                    <div class="form-group">
                        <label for="email">Email</label>
                           <input class='form-control' value='${requestScope.cliente.email}' required disabled>
                    </div>
                    
                    <div class="form-group">
                        <label for="email">Logradouro</label>
                           <input class='form-control' value='${requestScope.cliente.logradouro}' required disabled>
                    </div>
                    
                    
                    <div class="form-group">
                        <label for="numero">Numero</label>
                            <input class='form-control' value='${requestScope.cliente.numero}' required disabled>              
                    </div>
                    
                    <div class="form-group">
                        <label for="bairro">Bairro</label>
                        <input class='form-control' value='${requestScope.cliente.bairro}' required disabled>           
                    </div>
                    
                    <div class="form-group">
                        <label for="cep">CEP</label>
                        <input class='form-control' value='${requestScope.cliente.cep}' required disabled>
                    </div>
                    
                    
                    <div class="form-group">
                        <label for="idClassificacaoInterna">Cidade</label>
                        <input class='form-control' value='${requestScope.cliente.cidade.nome}' required disabled>
