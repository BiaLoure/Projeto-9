        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="${cp}/formularios/classificacaoInternas/listagem.jsp">Gêneros</a>
                </li>
                <li class="nav-item">
     ...
     <div class="container border my-4 shadow p-4 bg-light">
        ...
        <div class="row">
            <div class="col-12 text-center mb-4">
                <h1>Excluir Classificacao Interna</h1>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <form method="post" action="${cp}/processaClassificacoesInternas" class="mb-4">
                    ...
                    <div class="form-group">
                        <label for="descricao">Descricao</label>
                            <input class="form-control" value="${requestScope.classificacaoInterna.descricao}" disabled>
                    </div>
                    
                    <div class="form-group">
                        <label for="valorAluguel">Valor Aluguel</label>
                            <input class="form-control" value="${requestScope.classificacaoInterna.valorAluguel}" disabled>
                    </div>
                    ...
                    <div class="d-flex justify-content-between mt-5">
                        <a href="${cp}/formularios/classificacoesInternas/listagem.jsp" class="btn btn-secondary">Voltar</a>
